 ...
 * @author Langas
 */
public class ExpLD extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tbl_ExpLD.setForeground(new java.awt.Color(0, 0, 0));
        ...
        ExpLD.add(txt_Buscar_ExpLD, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 120, 290, 20));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ExpLD.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
